---
title: "Analysis to complement: Guiding malaria policy and control with mosquito data"
...
Initially we need to use the data available from RCT publications and additional data provided by co-authors to estimate model parameters for the model simulations. These details are provided in the accompanying paper [Sherrard-Smith et al 2021 draft].
...
And are also provided in the supplement of the manuscript [add reference].
