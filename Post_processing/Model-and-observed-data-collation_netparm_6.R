...
## ID 1 Bradley
run=1:1000
Tup_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/bradley/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)  ## filepath
Tup_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/bradley/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)  ## filepath

Tup_arm1 = array(dim=c(nrow(Tup_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:1000){
  Tup_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/bradley/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_2_14
}
Tup_arm2 = array(dim=c(nrow(Tup_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:1000){
  Tup_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/bradley/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_2_14
}
...
Tpp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/chaccour/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tpp_arm1 = array(dim=c(nrow(Tpp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in c(1:667,669:1000)){
  Tpp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/chaccour/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_all
}

Tpp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/chaccour/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Tpp_arm2 = array(dim=c(nrow(Tpp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tpp_arm2)){
  Tpp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/chaccour/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_all
}
...
## Data TRIAL
# Tap_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/corbel/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
# Tap_arm1 = array(dim=c(nrow(Tap_arm1a),1000)) ## this will be 1000 once all the runs are done
# for(i in 1:ncol(Tap_arm1)){
#   Tap_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/corbel/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
# }
Tap_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/corbel/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Tap_arm2 = array(dim=c(nrow(Tap_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tap_arm2)){
  Tap_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/corbel/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
}
# Tap_arm3a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/corbel/arm3/VALIDATION_trial_arm_3_net_1_0_1.txt",header=TRUE)
# Tap_arm3 = array(dim=c(nrow(Tap_arm3a),1000)) ## this will be 1000 once all the runs are done
# for(i in 1:ncol(Tap_arm3)){
#   Tap_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/corbel/arm3/VALIDATION_trial_arm_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
# }
...
for(t in 1:1301){
  ...
  # upp_Ta[t,2] = quantile(Tap_arm2[t,],0.975,na.rm=TRUE)
  # low_Ta[t,2] = quantile(Tap_arm2[t,],0.025,na.rm=TRUE)
  # med_Ta[t,2] = quantile(Tap_arm2[t,],0.5,na.rm=TRUE)
  # 
  # upp_Ta[t,3] = quantile(Tap_arm3[t,],0.975,na.rm=TRUE)
  # low_Ta[t,3] = quantile(Tap_arm3[t,],0.025,na.rm=TRUE)
  # med_Ta[t,3] = quantile(Tap_arm3[t,],0.5,na.rm=TRUE)
  # 
...
for(i in 1){
  ...
  polygon(c(Tap_arm2a[,1],rev(Tap_arm2a[,1])),c(upp_Ta[,i],rev(low_Ta[,i])),col = cols_Ta[i],border=NA)
  lines(med_Ta[,i] ~ Tap_arm2a[,1],lty=lty_Ta[i],lwd=lwd_Ta[i],col=cols_Ta2[i])
}

Tao_arm1 = c(0.253,0.195)
Tao_arm1_max = c(0.302,0.225)
Tao_arm1_min = c(0.224,0.166)

Tao_arm2 = c(0.301,0.200)
Tao_arm2_max = c(0.353,0.24)
Tao_arm2_min = c(0.248,0.16)

Tao_arm3 = c(0.373,0.256)
Tao_arm3_max = c(0.423,0.302)
Tao_arm3_min = c(0.322,0.210)


# effect_TA = c((Tao_arm1[2] - Tao_arm2[2])/Tao_arm1[2],
#               (Tao_arm1[2] - Tao_arm3[2])/Tao_arm1[2])
# 
# effect_TA_min = c((Tao_arm1_max[2] - Tao_arm2_max[2])/Tao_arm1[2],
#                   (Tao_arm1_max[2] - Tao_arm3_max[2])/Tao_arm1[2])
# 
# effect_TA_max = c((Tao_arm1_min[2] - Tao_arm2_min[2])/Tao_arm1[2],
#                   (Tao_arm1_min[2] - Tao_arm3_min[2])/Tao_arm1[2])
...
# points(Tao_arm1 ~ time_matchA, col="blue",pch=15,cex=1.5)
points(Tao_arm2 ~ c(time_matchA+0.01), col="red",pch=15,cex=1.5)
# points(Tao_arm3 ~ c(time_matchA+0.02), col="darkgreen",pch=15,cex=1.5)

# segments(x0=time_matchA,x1=time_matchA,y0=Tao_arm1_min,y1=Tao_arm1_max,lty=1,lwd=1.5,col="blue")
segments(x0=c(time_matchA+0.01),x1=c(time_matchA+0.01),y0=Tao_arm2_min,y1=Tao_arm2_max,lty=1,lwd=1.5,col="red")
# segments(x0=c(time_matchA+0.02),x1=c(time_matchA+0.02),y0=Tao_arm3_min,y1=Tao_arm3_max,lty=1,lwd=1.5,col="darkgreen")
...
Tbp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/curtis/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
...
for(i in 1:ncol(Tbp_arm1)){
  Tbp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/curtis/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
...
Tbp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/curtis/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
...
for(i in 1:ncol(Tbp_arm2)){
  Tbp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/curtis/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
  Bclin_inc_U5_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/curtis/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$clin_inc_0_5
}
Tbp_arm3a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/curtis/arm3/VALIDATION_trial_arm_3_net_1_0_1.txt",header=TRUE)
...
for(i in 1:ncol(Tbp_arm3)){
  Tbp_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/curtis/arm3/VALIDATION_trial_arm_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
  Bclin_inc_U5_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/curtis/arm3/VALIDATION_trial_arm_3_net_1_0_",run[i],".txt"),header=TRUE)$clin_inc_0_5
}
...
Tcp_arm1a = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/dalessandro/arm1/VALIDATION_trial_arm_1_1_net_1_0_1.txt"),header=TRUE)
Tcp_arm2a = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/dalessandro/arm2/VALIDATION_trial_arm_2_1_net_1_0_1.txt"),header=TRUE)
...
for(i in 1:ncol(Tcp_arm1_1)){
  ...
  Tcp_arm1_1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/dalessandro/arm1/VALIDATION_trial_arm_1_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm1_2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/dalessandro/arm1/VALIDATION_trial_arm_1_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm1_3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/dalessandro/arm1/VALIDATION_trial_arm_1_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm1_4[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/dalessandro/arm1/VALIDATION_trial_arm_1_4_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm1_5[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/dalessandro/arm1/VALIDATION_trial_arm_1_5_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
}
...
for(i in 1:ncol(Tcp_arm2_1)){
  Tcp_arm2_1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/dalessandro/arm2/VALIDATION_trial_arm_2_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm2_2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/dalessandro/arm2/VALIDATION_trial_arm_2_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm2_3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/dalessandro/arm2/VALIDATION_trial_arm_2_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm2_4[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/dalessandro/arm2/VALIDATION_trial_arm_2_4_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm2_5[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/dalessandro/arm2/VALIDATION_trial_arm_2_5_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
}
...
##
## E
## ID 7 Henry et al 2005
##
output1 = read.table("P:/validating_modelling/output_files/FINAL_netparm4/henry/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
...
for(i in 1:ncol(Tep_arm1)){
  Tep_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/henry/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
}
Tep_arm2 = array(dim=c(nrow(output1),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tep_arm2)){
  Tep_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/henry/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
}
...
## Data MODEL
Tfp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/kafy/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tfp_arm1 = array(dim=c(nrow(Tfp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:1000){
  Tfp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/kafy/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_4_6
}

Tfp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/kafy/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Tfp_arm2 = array(dim=c(nrow(Tfp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:1000){
  Tfp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/kafy/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_4_6
}
...
Thp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/marbiah/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Thp_arm1 = array(dim=c(nrow(Thp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Thp_arm1)){
  Thp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/marbiah/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_7
} ## Non-interventions
Thp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/marbiah/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Thp_arm2 = array(dim=c(nrow(Thp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Thp_arm2)){
  Thp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/marbiah/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_7
} ## Bo - Southern Province, Sierre Leone
...
Tsp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/nevill/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tsp_arm1 = array(dim=c(nrow(Tsp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tsp_arm1)){
  Tsp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/nevill/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_1
}

Tsp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/nevill/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Tsp_arm2 = array(dim=c(nrow(Tsp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tsp_arm2)){
  Tsp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/nevill/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_1
}
...
## Data TRIAL
Tjp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/philipshoward/arm1/VALIDATION_trial_arm_1_1_net_1_0_1.txt",header=TRUE)
Tjp_arm1 = array(dim=c(nrow(Tjp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tjp_arm1)){
  Tjp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/philipshoward/arm1/VALIDATION_trial_arm_1_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
} ## Non-interventions
Tjp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/philipshoward/arm2/VALIDATION_trial_arm_2_1_net_1_0_1.txt",header=TRUE)
Tjp_arm2 = array(dim=c(nrow(Tjp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tjp_arm2)){
  Tjp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/philipshoward/arm2/VALIDATION_trial_arm_2_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
} ## Asembo
Tjp_arm3a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/philipshoward/arm3/VALIDATION_trial_arm_3_2_net_1_0_1.txt",header=TRUE)
Tjp_arm3 = array(dim=c(nrow(Tjp_arm3a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tjp_arm3)){
  Tjp_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/philipshoward/arm3/VALIDATION_trial_arm_3_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
} ## Gem
...
## Data MODEL
Tlp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/protopopoff/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tlp_arm1 = array(dim=c(nrow(Tlp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tlp_arm1)){
  Tlp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/protopopoff/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
Tlp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/protopopoff/arm2/VALIDATION_trial_arm_2_net_2_0_1.txt",header=TRUE)
Tlp_arm2 = array(dim=c(nrow(Tlp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tlp_arm2)){
  Tlp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/protopopoff/arm2/VALIDATION_trial_arm_2_net_2_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
Tlp_arm3a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/protopopoff/arm3/VALIDATION_trial_arm_3_net_1_0_1.txt",header=TRUE)
Tlp_arm3 = array(dim=c(nrow(Tlp_arm3a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tlp_arm3)){
  Tlp_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/protopopoff/arm3/VALIDATION_trial_arm_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
Tlp_arm4a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/protopopoff/arm4/VALIDATION_trial_arm_4_net_2_0_1.txt",header=TRUE)
Tlp_arm4 = array(dim=c(nrow(Tlp_arm4a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tlp_arm4)){
  Tlp_arm4[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/protopopoff/arm4/VALIDATION_trial_arm_4_net_2_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
...
## Data MODEL
Tqp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/staedke/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tqp_arm1 = array(dim=c(nrow(Tqp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tqp_arm1)){
  Tqp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/staedke/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_2_10
}

Tqp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/staedke/arm2/VALIDATION_trial_arm_2_net_2_0_1.txt",header=TRUE)
Tqp_arm2 = array(dim=c(nrow(Tqp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tqp_arm2)){
  Tqp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/staedke/arm2/VALIDATION_trial_arm_2_net_2_0_",run[i],".txt"),header=TRUE)$prev_2_10
}
...
## O
## ID 15  West 2014
Top_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/west/arm1/VALIDATION_trial_arm_1_net_0_0_1.txt",header=TRUE)  ## filepath
Top_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm4/west/arm2/VALIDATION_trial_arm_2_net_0_0_1.txt",header=TRUE)  ## filepath

Top_arm1 = array(dim=c(nrow(Top_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Top_arm1)){
  Top_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/west/arm1/VALIDATION_trial_arm_1_net_0_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
Top_arm2 = array(dim=c(nrow(Top_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Top_arm2)){
  Top_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm4/west/arm2/VALIDATION_trial_arm_2_net_0_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
...
DATA_RESOURCE_Ef[,2] = c(#"ITN","ITN_IRS",
  rep(c("ITN","IRS"),each=4),
  rep("ITN",5),
  c("ITN","ITN"),
  c("ITN_IRS","ITN_IRS"),
  #"ITN","ITN","ITN","ITN",
...
OBSERVED_Effect_size_upper = c(#effect_TA_max,
  ...
  effect_TS,
  effect_TU_max)
DATA_RESOURCE_Ef[,5] = OBSERVED_Effect_size_upper
...
OBSERVED_Effect_size_lower = c(#effect_TA_min,
  ...
  effect_TS,
  effect_TU_min)
DATA_RESOURCE_Ef[,6] = OBSERVED_Effect_size_lower
...
PREDICTED_Effect_size= c(#model_Effect_TA,
  ...
  model_Effect_TS2,
  model_Effect_TU)
DATA_RESOURCE_Ef[,7] = PREDICTED_Effect_size
...
colnames(DATA_RESOURCE_Ef) = c("PI","Intervention","MONTH_prev_observed",
                               "Obs_eff_mean","Obs_eff_min","Obs_eff_max",
                               "Pred_3_eff","Pred_3_eff_min","Pred_3_eff_max")
write.csv(DATA_RESOURCE_Ef,"Post_processing/DATA_RESOURCE_EFFICACY_6.csv")
...
write.csv(DATA_RESOURCE_Pr,"Post_processing/DATA_RESOURCE_PREVALENCE_6.csv")
...
for(i in 1:length(unique(DATA_RESOURCE_Pr[,1]))){
  points(Prevalence_modelled_RCT~Prevalence_observed_RCT,cex=1.8)  
}
