...
## ID 1 Bradley
run=1:1000
Tup_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/bradley/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)  ## filepath
Tup_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/bradley/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)  ## filepath

Tup_arm1 = array(dim=c(nrow(Tup_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:1000){
  Tup_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/bradley/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_2_14
}
Tup_arm2 = array(dim=c(nrow(Tup_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:1000){
  Tup_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/bradley/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_2_14
}
...
legend("topright",legend = c("Pyrethroid ITN + Carbamate IRS",
                             "Pyrethroid ITN + Pyrethroid IRS"),
...
absolute_diff_t0_Bradley_obs = c(Tup_prev_recorded_t1[1] - Tup_prev_recorded_t1,
                                 Tup_prev_recorded_t2[1] - Tup_prev_recorded_t2)
absolute_diff_t0_Bradley_mod = c(model_estimates_TU1[1] - model_estimates_TU1,
                                 model_estimates_TU2[1] - model_estimates_TU2)

Babs_mod2 = c(Tup_prev_recorded_t1[1] - model_estimates_TU1,
              Tup_prev_recorded_t2[1] - model_estimates_TU2)

######################################
##
## ID 2 Chaccour et al 2020

Tpp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/chaccour/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tpp_arm1 = array(dim=c(nrow(Tpp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in c(1:667,669:1000)){
  Tpp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/chaccour/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_all
}

Tpp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/chaccour/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Tpp_arm2 = array(dim=c(nrow(Tpp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tpp_arm2)){
  Tpp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/chaccour/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_all
}
...
cmodel_estimates_TP1 = c(med_Tp[296,1],med_Tp[348,1])
cmodel_estimates_TP2 = c(med_Tp[296,2],med_Tp[348,2])

absolute_diff_t0_chaccour_obs = c(Tpp_prev_recorded_t1[1] - Tpp_prev_recorded_t1,
                                  Tpp_prev_recorded_t2[1] - Tpp_prev_recorded_t2)
absolute_diff_t0_chaccour_mod = c(cmodel_estimates_TP1[1] - cmodel_estimates_TP1,
                                  cmodel_estimates_TP2[1] - cmodel_estimates_TP2)

Cabs_mod2 = c(Tpp_prev_recorded_t1[1] - cmodel_estimates_TP1,
              Tpp_prev_recorded_t2[1] - cmodel_estimates_TP2)



################################################################
## A 
## ID 4 Corbel et al. 2012
## Data TRIAL

Tap_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/corbel/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Tap_arm2 = array(dim=c(nrow(Tap_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tap_arm2)){
  Tap_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/corbel/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
}
...
legend("topright",legend = c("Pyrethroid ITN (universal)"),
       col = c("darkred"), pch = 15,bty="n")
...
cols_Ta = adegenet::transp(c("darkred"),0.4)
cols_Ta2 = c("darkred")
lty_Ta = c(1,1,1,6)
lwd_Ta = c(2,2,2,2)
for(i in 1){
  
  polygon(c(Tap_arm1a[,1],rev(Tap_arm1a[,1])),c(upp_Ta[,i],rev(low_Ta[,i])),col = cols_Ta[i],border=NA)
  lines(med_Ta[,i] ~ Tap_arm1a[,1],lty=lty_Ta[i],lwd=lwd_Ta[i],col=cols_Ta2[i])
}
...
points(Tao_arm2 ~ c(time_matchA+0.01), col="red",pch=15,cex=1.5)
segments(x0=c(time_matchA+0.01),x1=c(time_matchA+0.01),y0=Tao_arm2_min,y1=Tao_arm2_max,lty=1,lwd=1.5,col="red")


model_estimates_TA2 = mean(Tap_arm2[335,])

Tap_arm1a$year[335] ## confirm this aligns with the time of observation
...
Tbp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/curtis/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
...
for(i in 1:ncol(Tbp_arm1)){
  Tbp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/curtis/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
...
Tbp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/curtis/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
...
for(i in 1:ncol(Tbp_arm2)){
  Tbp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/curtis/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
  Bclin_inc_U5_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/curtis/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$clin_inc_0_5
}
Tbp_arm3a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/curtis/arm3/VALIDATION_trial_arm_3_net_1_0_1.txt",header=TRUE)
...
for(i in 1:ncol(Tbp_arm3)){
  Tbp_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/curtis/arm3/VALIDATION_trial_arm_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
  Bclin_inc_U5_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/curtis/arm3/VALIDATION_trial_arm_3_net_1_0_",run[i],".txt"),header=TRUE)$clin_inc_0_5
}
...
absolute_diff_t0_curtis_obs = c(Tbo_arm1[1] - Tbo_arm1,Tbo_arm2[1] - Tbo_arm2,Tbo_arm3[1] - Tbo_arm3)
absolute_diff_t0_curtis_mod = c(0,med_Tb[261,1] - model_estimates_TB1,
                                0,med_Tb[261,2] - model_estimates_TB2,
                                0,med_Tb[261,3] - model_estimates_TB3)

C3abs_mod2 = c(0,Tbo_arm1[1] - model_estimates_TB1,
               0,Tbo_arm2[1] - model_estimates_TB2,
               0,Tbo_arm3[1] - model_estimates_TB3)
...
Tcp_arm1a = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/dalessandro/arm1/VALIDATION_trial_arm_1_1_net_1_0_1.txt"),header=TRUE)
Tcp_arm2a = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/dalessandro/arm2/VALIDATION_trial_arm_2_1_net_1_0_1.txt"),header=TRUE)
...
for(i in 1:ncol(Tcp_arm1_1)){
  ...
  Tcp_arm1_1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/dalessandro/arm1/VALIDATION_trial_arm_1_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm1_2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/dalessandro/arm1/VALIDATION_trial_arm_1_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm1_3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/dalessandro/arm1/VALIDATION_trial_arm_1_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm1_4[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/dalessandro/arm1/VALIDATION_trial_arm_1_4_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm1_5[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/dalessandro/arm1/VALIDATION_trial_arm_1_5_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
}
...
for(i in 1:ncol(Tcp_arm2_1)){
  Tcp_arm2_1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/dalessandro/arm2/VALIDATION_trial_arm_2_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm2_2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/dalessandro/arm2/VALIDATION_trial_arm_2_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm2_3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/dalessandro/arm2/VALIDATION_trial_arm_2_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm2_4[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/dalessandro/arm2/VALIDATION_trial_arm_2_4_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm2_5[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/dalessandro/arm2/VALIDATION_trial_arm_2_5_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
}
...
model_estimates_TC2 = c(med_Tc[343,2,1],med_Tc[343,2,2],med_Tc[343,2,3],med_Tc[343,2,4],med_Tc[343,2,5])
...
absolute_diff_t0_daless_obs = c(Tco_arm1 - Tco_arm1b,
                                Tco_arm2 - Tco_arm2b)
base_dalessandro = c(med_Tc[239,1,1],med_Tc[239,1,2],med_Tc[239,1,3],med_Tc[239,1,4],med_Tc[239,1,5])

absolute_diff_t0_daless_mod = c(base_dalessandro - model_estimates_TC1,
                                base_dalessandro - model_estimates_TC2)

Dabs_mod2 = c(Tco_arm1 - model_estimates_TC1,
              Tco_arm2 - model_estimates_TC2)
...
##
output1 = read.table("P:/validating_modelling/output_files/FINAL_netparm2/henry/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
...
for(i in 1:ncol(Tep_arm1)){
  Tep_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/henry/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
}
Tep_arm2 = array(dim=c(nrow(output1),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tep_arm2)){
  Tep_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/henry/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
}
...
absolute_diff_t0_henry_obs = c(Teo_arm1[1] - Teo_arm1,Teo_arm2[1] - Teo_arm2)
absolute_diff_t0_henry_mod = c(model_estimates_TE1[1] - model_estimates_TE1,
                               model_estimates_TE2[1] - model_estimates_TE2)

Habs_mod2 = c(Teo_arm1[1] - model_estimates_TE1,
              Teo_arm2[1] - model_estimates_TE2)
################################################################
## F 
...
## Data MODEL
Tfp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/kafy/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tfp_arm1 = array(dim=c(nrow(Tfp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:1000){
  Tfp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/kafy/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_4_6
}

Tfp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/kafy/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Tfp_arm2 = array(dim=c(nrow(Tfp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:1000){
  Tfp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/kafy/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_4_6
}
...
absolute_diff_t0_kafy_obs = c(Tfo_arm1[1] - Tfo_arm1,Tfo_arm2[1] - Tfo_arm2)
absolute_diff_t0_kafy_mod = c(model_estimates_TF1[1] - model_estimates_TF1,
                              model_estimates_TF2[1] - model_estimates_TF2)
Kabs_mod2 = c(Tfo_arm1[1] - model_estimates_TF1,
              Tfo_arm2[1] - model_estimates_TF2)
...
################################################################
## H 
## ID 10 MARBIAH 1992 - 1994

#  ## Bo - Southern Province, Sierre Leone

Thp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/marbiah/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Thp_arm1 = array(dim=c(nrow(Thp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Thp_arm1)){
  Thp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/marbiah/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_7
} ## Non-interventions
Thp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/marbiah/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Thp_arm2 = array(dim=c(nrow(Thp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Thp_arm2)){
  Thp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/marbiah/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_7
} ## Bo - Southern Province, Sierre Leone
...
cmodel_estimates_TH1 = c(mean(Thp_arm1[244,]),mean(Thp_arm1[300,]))
cmodel_estimates_TH2 = c(mean(Thp_arm2[244,]),mean(Thp_arm2[300,]))

absolute_diff_t0_marbiah_obs = c(Tho_arm1[1] - Tho_arm1,Tho_arm2[1] - Tho_arm2)
absolute_diff_t0_marbiah_mod = c(cmodel_estimates_TH1[1] - cmodel_estimates_TH1,
                                 cmodel_estimates_TH2[1] - cmodel_estimates_TH2)
Mabs_mod2 = c(Tho_arm1[1] - cmodel_estimates_TH1,
              Tho_arm2[1] - cmodel_estimates_TH2)
#############################
##
## S 
## ID 11 Nevill et al 1996


Tsp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/nevill/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tsp_arm1 = array(dim=c(nrow(Tsp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tsp_arm1)){
  Tsp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/nevill/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_1
}

Tsp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/nevill/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Tsp_arm2 = array(dim=c(nrow(Tsp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tsp_arm2)){
  Tsp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/nevill/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_1
}
...
absolute_diff_t0_nevil_obs = c(nevil_base[1] - Tsp_prev_recorded_t1,
                               nevil_base[2] - Tsp_prev_recorded_t2)
absolute_diff_t0_nevil_mod = c(med_Tp[248,1] - model_estimates_TS1,
                               med_Tp[248,2] -model_estimates_TS2)
Nabs_mod2 = c(nevil_base[1] - model_estimates_TS1,
                               nevil_base[2] -model_estimates_TS2)

################################################################
## J 
## ID 12 Philips Howard et al 2003

## Data TRIAL
Tjp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/philipshoward/arm1/VALIDATION_trial_arm_1_1_net_1_0_1.txt",header=TRUE)
Tjp_arm1 = array(dim=c(nrow(Tjp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tjp_arm1)){
  Tjp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/philipshoward/arm1/VALIDATION_trial_arm_1_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
} ## Non-interventions
Tjp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/philipshoward/arm2/VALIDATION_trial_arm_2_1_net_1_0_1.txt",header=TRUE)
Tjp_arm2 = array(dim=c(nrow(Tjp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tjp_arm2)){
  Tjp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/philipshoward/arm2/VALIDATION_trial_arm_2_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
} ## Asembo
Tjp_arm3a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/philipshoward/arm3/VALIDATION_trial_arm_3_2_net_1_0_1.txt",header=TRUE)
Tjp_arm3 = array(dim=c(nrow(Tjp_arm3a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tjp_arm3)){
  Tjp_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/philipshoward/arm3/VALIDATION_trial_arm_3_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
} ## Gem
...
absolute_diff_t0_philhow_obs = c(Tjo_arm1[1] - Tjo_arm1,
                                 Tjo_arm2[1] - Tjo_arm2)
absolute_diff_t0_philhow_mod = c(0,mean(Tjp_arm1[261,]) - model_estimates_TJ1,
                                 0,mean(Tjp_arm3[261,]) - model_estimates_TJ3)
PHabs_mod2 = c(0,Tjo_arm1[1] - model_estimates_TJ1,
                                 0,Tjo_arm2[1] - model_estimates_TJ3)

################################################################
## L
## ID 13 Protopopoff et al. 2018
## Data TRIAL
...
## Data MODEL
Tlp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/protopopoff/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tlp_arm1 = array(dim=c(nrow(Tlp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tlp_arm1)){
  Tlp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/protopopoff/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
Tlp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/protopopoff/arm2/VALIDATION_trial_arm_2_net_2_0_1.txt",header=TRUE)
Tlp_arm2 = array(dim=c(nrow(Tlp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tlp_arm2)){
  Tlp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/protopopoff/arm2/VALIDATION_trial_arm_2_net_2_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
Tlp_arm3a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/protopopoff/arm3/VALIDATION_trial_arm_3_net_1_0_1.txt",header=TRUE)
Tlp_arm3 = array(dim=c(nrow(Tlp_arm3a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tlp_arm3)){
  Tlp_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/protopopoff/arm3/VALIDATION_trial_arm_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
Tlp_arm4a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/protopopoff/arm4/VALIDATION_trial_arm_4_net_2_0_1.txt",header=TRUE)
Tlp_arm4 = array(dim=c(nrow(Tlp_arm4a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tlp_arm4)){
  Tlp_arm4[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/protopopoff/arm4/VALIDATION_trial_arm_4_net_2_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
...
absolute_diff_t0_protop_obs = c(0.68 - Tlo_arm1,
                                0.61 - Tlo_arm2,
                                0.67 - Tlo_arm3,
                                0.64 - Tlo_arm4)
absolute_diff_t0_protop_mod = c(mean(Tlp_arm1[252,],na.rm=TRUE) - model_estimates_TL1,
                                mean(Tlp_arm2[252,],na.rm=TRUE) - model_estimates_TL2,
                                mean(Tlp_arm3[252,],na.rm=TRUE) - model_estimates_TL3,
                                mean(Tlp_arm4[252,],na.rm=TRUE) - model_estimates_TL4)

PRabs_mod2 = c(0.68 - model_estimates_TL1,
               0.61 - model_estimates_TL2,
               0.67 - model_estimates_TL3,
               0.64 - model_estimates_TL4)
...
## Data MODEL
Tqp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/staedke/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tqp_arm1 = array(dim=c(nrow(Tqp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tqp_arm1)){
  Tqp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/staedke/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_2_10
}

Tqp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/staedke/arm2/VALIDATION_trial_arm_2_net_2_0_1.txt",header=TRUE)
Tqp_arm2 = array(dim=c(nrow(Tqp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tqp_arm2)){
  Tqp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/staedke/arm2/VALIDATION_trial_arm_2_net_2_0_",run[i],".txt"),header=TRUE)$prev_2_10
}
...
absolute_diff_t0_staedke_obs = c(Tqo_arm1[1] - Tqo_arm1,Tqo_arm2[1]-Tqo_arm2)
absolute_diff_t0_staedke_mod = c(model_estimates_TQ1[1] - model_estimates_TQ1,
                                 model_estimates_TQ2[1] - model_estimates_TQ2)
Sabs_mod2 = c(Tqo_arm1[1] - model_estimates_TQ1,
                                 Tqo_arm2[1] - model_estimates_TQ2)
####################################################################
## O
## ID 15  West 2014
Top_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/west/arm1/VALIDATION_trial_arm_1_net_0_0_1.txt",header=TRUE)  ## filepath
Top_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm2/west/arm2/VALIDATION_trial_arm_2_net_0_0_1.txt",header=TRUE)  ## filepath

Top_arm1 = array(dim=c(nrow(Top_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Top_arm1)){
  Top_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/west/arm1/VALIDATION_trial_arm_1_net_0_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
Top_arm2 = array(dim=c(nrow(Top_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Top_arm2)){
  Top_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm2/west/arm2/VALIDATION_trial_arm_2_net_0_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
...
absolute_diff_t0_west_obs = c(Top_prev_recorded_t1[1] - Top_prev_recorded_t1,
                              Top_prev_recorded_t2[1] - Top_prev_recorded_t2)
absolute_diff_t0_west_mod = c(model_estimates_TO1[1] - model_estimates_TO1,
                              model_estimates_TO2[1] - model_estimates_TO2)
Wabs_mod2 = c(Top_prev_recorded_t1[1] - model_estimates_TO1,
              Top_prev_recorded_t2[1] - model_estimates_TO2)

###################################
##
## Average predictions

absolute_doff_OBS = c(#absolute_diff_t0_Abuaku_obs,
                      absolute_diff_t0_Bradley_obs,
                      absolute_diff_t0_chaccour_obs,
                      # absolute_diff_t0_corbel_obs,
                      absolute_diff_t0_curtis_obs,
                      absolute_diff_t0_daless_obs,
                      absolute_diff_t0_henry_obs,
                      absolute_diff_t0_kafy_obs,
                      absolute_diff_t0_marbiah_obs,
                      absolute_diff_t0_nevil_obs,
                      absolute_diff_t0_philhow_obs,
                      absolute_diff_t0_protop_obs,
                      absolute_diff_t0_staedke_obs,
                      absolute_diff_t0_west_obs)

absolute_doff_MOD = c(#absolute_diff_t0_Abuaku_mod,
                      absolute_diff_t0_Bradley_mod,
                      absolute_diff_t0_chaccour_mod,
                      # absolute_diff_t0_corbel_mod,
                      absolute_diff_t0_curtis_mod,
                      absolute_diff_t0_daless_mod,
                      absolute_diff_t0_henry_mod,
                      absolute_diff_t0_kafy_mod,
                      absolute_diff_t0_marbiah_mod,
                      absolute_diff_t0_nevil_mod,
                      absolute_diff_t0_philhow_mod,
                      absolute_diff_t0_protop_mod,
                      absolute_diff_t0_staedke_mod,
                      absolute_diff_t0_west_mod)

abs_MOD2 = c(#Aabs_mod2,
                      Babs_mod2,
                      Cabs_mod2,
                      # C2abs_mod2,
                      C3abs_mod2,
...
absolute_diff = data.frame(absolute_doff_MOD,
           absolute_doff_OBS,abs_MOD2,
           study = rep(1:12,c(4,4,15,10,4,6,4,6,6,16,8,8)))
# write.csv(absolute_diff,"Post_processing/absolute_dff2.csv")
databs = c(absolute_doff_MOD,absolute_doff_OBS)
dattypabs = rep(c("mod","obs"),each=length(absolute_doff_MOD))
summary.lm(aov(databs ~ dattypabs))

abs_dat = read.csv("Post_processing/absolute_dff2.csv",header=TRUE)
plot(abs_dat$absolute_doff_OBS ~ abs_dat$absolute_doff_MOD,
     col=abs_dat$col,
       pch=abs_dat$study,
     ylim=c(-0.1,0.5),xlim=c(-0.1,0.5),
     main="Absolute difference in prevalence",
     ylab="RCT Observed absolute difference",
     xlab="Model simulated absolute difference")
yy=seq(-1,1,0.1)
xx=seq(-1,1,0.1)
lines(yy,xx,lty=2)
plot(abs_dat$absolute_doff_OBS ~ abs_dat$abs_ob_MOD,
     col=abs_dat$col,
     pch=abs_dat$study,
     ylim=c(-0.1,0.5),xlim=c(-0.1,0.5),
     main="Absolute difference in effiprevalence",
     ylab="RCT Observed absolute difference",
     xlab="Model simulated absolute difference (from obs)")
lines(yy,xx,lty=2)

summary.lm(lm(abs_dat$absolute_doff_OBS ~ abs_dat$abs_ob_MOD + 0))
summary.lm(lm(abs_dat$absolute_doff_OBS ~ abs_dat$absolute_doff_MOD + 0))

difference_o_Mm = abs_dat$absolute_doff_OBS - abs_dat$absolute_doff_MOD
# difference_o_Om = abs_dat$absolute_doff_OBS - abs_dat$abs_ob_MOD
# par(mfrow=c(2,1))
boxplot(difference_o_Mm~abs_dat$intvn,
        col=c("darkred","aquamarine3","grey70","blue","purple","orange","grey20"),
        ylab = "Absolute difference (Obvs-Obvs : Mod-Mod)",
        xlab="",yaxt="n")
axis(2,las=2,at=c(-0,2,-0.1,0,0.1,0.2))
abline(h=0,lty=2)
#########################################################
##
## Efficacy figure
DATA_RESOURCE_Ef = expand.grid(study = rep(c(#"Corbel",#A
                                             "Curtis",#B
                                             "D'Alessandro",#C
                                             "Henry",#E
                                             "Kafy",#F
...
DATA_RESOURCE_Ef[,2] = c(rep(c("ITN","IRS"),each=4),
                         ...
                         "ITN",
                         "ITN","ITN",
                         rep("PBO_ITN",4),rep(c("ITN_IRS","PBO_ITN_IRS"),each=4),
...
OBSERVED_Effect_size = c(#effect_TA,
                         effect_TB,
                         effect_TC,
                         effect_TE,
                         effect_TF[2:3],
...
PREDICTED_Effect_size= c(#model_Effect_TA,
                         model_Effect_TB,
                         model_Effect2_TC,
                         model_Effect_TE,
                         model_Effect_TF[2:3],
...
OBSERVED_Effect_size_upper = c(#effect_TA_max,
                               effect_TB,
                               effect_TC,
                               effect_TE_max,
                               effect_TF_max[2:3],
...
OBSERVED_Effect_size_lower = c(#effect_TA_min,
                               effect_TB,
                               effect_TC,
                               effect_TE_min,
                               effect_TF_min[2:3],
...
PREDICTED_Effect_size_upper = c(#model_Effect_TA_max,
                                model_Effect_TB_max,
...
PREDICTED_Effect_size_lower = c(#model_Effect_TA_min,
                                model_Effect_TB_min,
...
##Loha
# VALES = 261+52*time_match_G1
# Tgo_prev_measured = c(0.09,0.05,0.06,0.04,0.05,0.055,0.05,0.06) ## do nothing
# Tgo_prev_measured_min = c(0.03,0.02,0.02,0.03,0.03,0.02,0.02,0.04)
# Tgo_prev_measured_max = c(0.12,0.06,0.07,0.07,0.1,0.09,0.09,0.08)
# model_TG_prev_measured = c(med_Tg[VALES[1],4],med_Tg[VALES[2],4],med_Tg[VALES[3],4],med_Tg[VALES[4],4],med_Tg[VALES[1],2],med_Tg[VALES[2],2],med_Tg[VALES[3],2],med_Tg[VALES[4],2])
# model_TG_prev_measured_max = c(upp_Tg[VALES[1],4],upp_Tg[VALES[2],4],upp_Tg[VALES[3],4],upp_Tg[VALES[4],4],upp_Tg[VALES[1],2],upp_Tg[VALES[2],2],upp_Tg[VALES[3],2],upp_Tg[VALES[4],2])
# model_TG_prev_measured_min = c(low_Tg[VALES[1],4],low_Tg[VALES[2],4],low_Tg[VALES[3],4],low_Tg[VALES[4],4],low_Tg[VALES[1],2],low_Tg[VALES[2],2],low_Tg[VALES[3],2],low_Tg[VALES[4],2])
...
## Abuaku
# TWp_prev_measured = c(47.7,25.2,20.6,6.9,22.2)/100
# TWp_prev_measured_max = c(49.9,27.2,22.9,8.1,24.5)/100
# TWp_prev_measured_min = c(45.5,23.4,18.4,5.9,20.1)/100
# model_TW_prev_measured = c(med_Tw[values_w[3],1],
#                            med_Tw[values_w[4],1],med_Tw[values_w[5],1],med_Tw[values_w[6],1],
#                            med_Tw[values_w[7],1])
# model_TW_prev_measured_max = c(upp_Tw[values_w[3],1],
#                                upp_Tw[values_w[4],1],upp_Tw[values_w[5],1],upp_Tw[values_w[6],1],
#                                upp_Tw[values_w[7],1])
# model_TW_prev_measured_min = c(low_Tw[values_w[3],1],
#                                low_Tw[values_w[4],1],low_Tw[values_w[5],1],low_Tw[values_w[6],1],
#                                low_Tw[values_w[7],1])

# ##Hamainza
# Txp_prev_measured = c((372+809)/(1508+3006),##range 24.7 - 26.9 Jan 2011
#                       (95+436)/(998+4033),##range 9.5 - 10.8 Jan 2012
#                       (150+282)/(1039+2004),##range 14.1 - 14.4 Jan 2013
#                       (338+144)/(2845+2415),##range  Jan 2011
#                       (76+130)/(1457+3261),##range Jan 2012
#                       (57+33)/(1505+1105),##range Jan 2013 
#                       (26+33)/(42+63),##range Jan 2011
#                       (514+786)/(1517+1904),##range Jan 2012
#                       (246+221)/(1132+1301))##range Jan 2013  
# 
# time_match_X = (1/12) * c(11,23,35)##because the surveys were done 2 months into the year
# 
# values_x = 261+52*time_match_X
# 
# model_TX_prev_measured = c(med_Tx[values_x[1],1],med_Tx[values_x[2],1],med_Tx[values_x[3],1],
#                            med_Tx[values_x[1],2],med_Tx[values_x[2],2],med_Tx[values_x[3],2],
#                            med_Tx[values_x[1],3],med_Tx[values_x[2],3],med_Tx[values_x[3],3])
# model_TX_prev_measured_max = c(low_Tx[values_x[1],1],low_Tx[values_x[2],1],low_Tx[values_x[3],1],
#                                low_Tx[values_x[1],2],low_Tx[values_x[2],2],low_Tx[values_x[3],2],
#                                low_Tx[values_x[1],3],low_Tx[values_x[2],3],low_Tx[values_x[3],3])
# model_TX_prev_measured_min = c(upp_Tx[values_x[1],1],upp_Tx[values_x[2],1],upp_Tx[values_x[3],1],
#                                upp_Tx[values_x[1],2],upp_Tx[values_x[2],2],upp_Tx[values_x[3],2],
#                                upp_Tx[values_x[1],3],upp_Tx[values_x[2],3],upp_Tx[values_x[3],3])
# 
##
##
## prevalence
...
DATA_RESOURCE_Pr[,2] = c("ITN",#A Corbel; Delt itn targ vs uni, vs targ+IRS, vs uni+IRS
                         ...
                         rep(c("ITN","PBO_ITN","ITN_IRS","PBO_ITN_IRS"),each=4),#L Proto
...
intvn_symb3 = c(0,#A Corbel; Delt itn targ vs uni, vs targ+IRS, vs uni+IRS
                ...
                19,0,#K Pinder
                rep(c(19,8,0,11),each=4),#L Proto
...
write.csv(DATA_RESOURCE_Pr,"Post_processing/DATA_RESOURCE_PREVALENCE_2.csv")
...
intvn_symb = rep(c(#15,#A
                 ...
                 c(8,5,2,2,#4,
                   1,2,12,3,
                   1,3,3,2))
study_symb = c(rep(1,8),rep(2,5),3,3,4,4,5,6,6,
               rep(7,12),
...
month_prev_COL = c(#"darkgreen","darkgreen",#A
                   ...
                   "darkblue",#H
                   "darkblue","black",#J
                   "grey","lightgreen","darkgreen","darkblue",#"black","black",
                   "grey","lightgreen","darkgreen","darkblue",#"black","black",
                   "grey","lightgreen","darkgreen","darkblue",#"black","black",#L
...
write.csv(DATA_RESOURCE_Ef,"Post_processing/DATA_RESOURCE_EFFICACY_2.csv")
