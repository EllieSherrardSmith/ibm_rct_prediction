...
## ID 1 Bradley
run=1:1000
Tup_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/bradley/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)  ## filepath
Tup_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/bradley/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)  ## filepath

Tup_arm1 = array(dim=c(nrow(Tup_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:1000){
  Tup_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/bradley/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_2_14
}
Tup_arm2 = array(dim=c(nrow(Tup_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:1000){
  Tup_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/bradley/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_2_14
}
...
Tpp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/chaccour/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tpp_arm1 = array(dim=c(nrow(Tpp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in c(1:667,669:1000)){
  Tpp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/chaccour/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_all
}

Tpp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/chaccour/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Tpp_arm2 = array(dim=c(nrow(Tpp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tpp_arm2)){
  Tpp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/chaccour/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_all
}
...
## Data TRIAL
# Tap_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/corbel/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
# Tap_arm1 = array(dim=c(nrow(Tap_arm1a),1000)) ## this will be 1000 once all the runs are done
# for(i in 1:ncol(Tap_arm1)){
#   Tap_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/corbel/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
# }
Tap_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/corbel/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Tap_arm2 = array(dim=c(nrow(Tap_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tap_arm2)){
  Tap_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/corbel/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
}
# Tap_arm3a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/corbel/arm3/VALIDATION_trial_arm_3_net_1_0_1.txt",header=TRUE)
# Tap_arm3 = array(dim=c(nrow(Tap_arm3a),1000)) ## this will be 1000 once all the runs are done
# for(i in 1:ncol(Tap_arm3)){
#   Tap_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/corbel/arm3/VALIDATION_trial_arm_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
# }
...
Tbp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/curtis/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
...
for(i in 1:ncol(Tbp_arm1)){
  Tbp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/curtis/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
...
Tbp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/curtis/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
...
for(i in 1:ncol(Tbp_arm2)){
  Tbp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/curtis/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
  Bclin_inc_U5_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/curtis/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$clin_inc_0_5
}
Tbp_arm3a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/curtis/arm3/VALIDATION_trial_arm_3_net_1_0_1.txt",header=TRUE)
...
for(i in 1:ncol(Tbp_arm3)){
  Tbp_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/curtis/arm3/VALIDATION_trial_arm_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_6
  Bclin_inc_U5_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/curtis/arm3/VALIDATION_trial_arm_3_net_1_0_",run[i],".txt"),header=TRUE)$clin_inc_0_5
}
...
Tcp_arm1a = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/dalessandro/arm1/VALIDATION_trial_arm_1_1_net_1_0_1.txt"),header=TRUE)
Tcp_arm2a = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/dalessandro/arm2/VALIDATION_trial_arm_2_1_net_1_0_1.txt"),header=TRUE)
...
for(i in 1:ncol(Tcp_arm1_1)){
  ...
  Tcp_arm1_1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/dalessandro/arm1/VALIDATION_trial_arm_1_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm1_2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/dalessandro/arm1/VALIDATION_trial_arm_1_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm1_3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/dalessandro/arm1/VALIDATION_trial_arm_1_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm1_4[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/dalessandro/arm1/VALIDATION_trial_arm_1_4_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm1_5[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/dalessandro/arm1/VALIDATION_trial_arm_1_5_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
}
...
for(i in 1:ncol(Tcp_arm2_1)){
  Tcp_arm2_1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/dalessandro/arm2/VALIDATION_trial_arm_2_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm2_2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/dalessandro/arm2/VALIDATION_trial_arm_2_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm2_3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/dalessandro/arm2/VALIDATION_trial_arm_2_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm2_4[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/dalessandro/arm2/VALIDATION_trial_arm_2_4_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
  Tcp_arm2_5[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/dalessandro/arm2/VALIDATION_trial_arm_2_5_net_1_0_",run[i],".txt"),header=TRUE)$prev_1_4
}
...
##
output1 = read.table("P:/validating_modelling/output_files/FINAL_netparm6/henry/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
...
for(i in 1:ncol(Tep_arm1)){
  Tep_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/henry/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
}
Tep_arm2 = array(dim=c(nrow(output1),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tep_arm2)){
  Tep_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/henry/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
}
...
## Data MODEL
Tfp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/kafy/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tfp_arm1 = array(dim=c(nrow(Tfp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:1000){
  Tfp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/kafy/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_4_6
}

Tfp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/kafy/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Tfp_arm2 = array(dim=c(nrow(Tfp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:1000){
  Tfp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/kafy/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_4_6
}
...
Thp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/marbiah/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Thp_arm1 = array(dim=c(nrow(Thp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Thp_arm1)){
  Thp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/marbiah/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_7
} ## Non-interventions
Thp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/marbiah/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Thp_arm2 = array(dim=c(nrow(Thp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Thp_arm2)){
  Thp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/marbiah/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_7
} ## Bo - Southern Province, Sierre Leone
...
Tsp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/nevill/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tsp_arm1 = array(dim=c(nrow(Tsp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tsp_arm1)){
  Tsp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/nevill/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_1
}

Tsp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/nevill/arm2/VALIDATION_trial_arm_2_net_1_0_1.txt",header=TRUE)
Tsp_arm2 = array(dim=c(nrow(Tsp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tsp_arm2)){
  Tsp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/nevill/arm2/VALIDATION_trial_arm_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_1
}
...
## Data TRIAL
Tjp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/philipshoward/arm1/VALIDATION_trial_arm_1_1_net_1_0_1.txt",header=TRUE)
Tjp_arm1 = array(dim=c(nrow(Tjp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tjp_arm1)){
  Tjp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/philipshoward/arm1/VALIDATION_trial_arm_1_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
} ## Non-interventions
Tjp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/philipshoward/arm2/VALIDATION_trial_arm_2_1_net_1_0_1.txt",header=TRUE)
Tjp_arm2 = array(dim=c(nrow(Tjp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tjp_arm2)){
  Tjp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/philipshoward/arm2/VALIDATION_trial_arm_2_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
} ## Asembo
Tjp_arm3a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/philipshoward/arm3/VALIDATION_trial_arm_3_2_net_1_0_1.txt",header=TRUE)
Tjp_arm3 = array(dim=c(nrow(Tjp_arm3a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tjp_arm3)){
  Tjp_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/philipshoward/arm3/VALIDATION_trial_arm_3_2_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_5
} ## Gem
...
## Data MODEL
Tlp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/protopopoff/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tlp_arm1 = array(dim=c(nrow(Tlp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tlp_arm1)){
  Tlp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/protopopoff/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
Tlp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/protopopoff/arm2/VALIDATION_trial_arm_2_net_2_0_1.txt",header=TRUE)
Tlp_arm2 = array(dim=c(nrow(Tlp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tlp_arm2)){
  Tlp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/protopopoff/arm2/VALIDATION_trial_arm_2_net_2_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
Tlp_arm3a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/protopopoff/arm3/VALIDATION_trial_arm_3_net_1_0_1.txt",header=TRUE)
Tlp_arm3 = array(dim=c(nrow(Tlp_arm3a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tlp_arm3)){
  Tlp_arm3[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/protopopoff/arm3/VALIDATION_trial_arm_3_net_1_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
Tlp_arm4a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/protopopoff/arm4/VALIDATION_trial_arm_4_net_2_0_1.txt",header=TRUE)
Tlp_arm4 = array(dim=c(nrow(Tlp_arm4a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tlp_arm4)){
  Tlp_arm4[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/protopopoff/arm4/VALIDATION_trial_arm_4_net_2_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
...
## Data MODEL
Tqp_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/staedke/arm1/VALIDATION_trial_arm_1_net_1_0_1.txt",header=TRUE)
Tqp_arm1 = array(dim=c(nrow(Tqp_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tqp_arm1)){
  Tqp_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/staedke/arm1/VALIDATION_trial_arm_1_net_1_0_",run[i],".txt"),header=TRUE)$prev_2_10
}

Tqp_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/staedke/arm2/VALIDATION_trial_arm_2_net_2_0_1.txt",header=TRUE)
Tqp_arm2 = array(dim=c(nrow(Tqp_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Tqp_arm2)){
  Tqp_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/staedke/arm2/VALIDATION_trial_arm_2_net_2_0_",run[i],".txt"),header=TRUE)$prev_2_10
}
...
## O
## ID 14  West 2014
Top_arm1a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/west/arm1/VALIDATION_trial_arm_1_net_0_0_1.txt",header=TRUE)  ## filepath
Top_arm2a = read.table("P:/validating_modelling/output_files/FINAL_netparm6/west/arm2/VALIDATION_trial_arm_2_net_0_0_1.txt",header=TRUE)  ## filepath

Top_arm1 = array(dim=c(nrow(Top_arm1a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Top_arm1)){
  Top_arm1[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/west/arm1/VALIDATION_trial_arm_1_net_0_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
Top_arm2 = array(dim=c(nrow(Top_arm2a),1000)) ## this will be 1000 once all the runs are done
for(i in 1:ncol(Top_arm2)){
  Top_arm2[,i] = read.table(paste0("P:/validating_modelling/output_files/FINAL_netparm6/west/arm2/VALIDATION_trial_arm_2_net_0_0_",run[i],".txt"),header=TRUE)$prev_0_14
}
...
# write.csv(DATA_RESOURCE_Ef,"Post_processing/DATA_RESOURCE_EFFICACY_3.csv")
...
# write.csv(DATA_RESOURCE_Pr,"Post_processing/DATA_RESOURCE_PREVALENCE_3.csv")
