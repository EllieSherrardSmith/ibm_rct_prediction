...
functions_model_runs_bradley<-function(DIDE_CODE,
  ...
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm3/bradley/arm", arm),
                 Options=Options,
...
chac_trial_f<-function(DIDE_CODE, ## Zambezia list 1:2000
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm3/chaccour/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
corb_trial_f1<-function(DIDE_CODE,
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm3/corbel/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
curt_trial_f1<-function(DIDE_CODE,
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm3/curtis/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
DALESS_trial_f1<-function(DIDE_CODE,
  ...
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,sitnum,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm3/dalessandro/arm",arm),
                 Options=Options,
...
HENRY_trial_f1<-function(DIDE_CODE,
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm3/henry/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe", ## The model executable
                 Root="P:/validating_modelling/input_files",
...
functions_model_runs_kafy<-function(DIDE_CODE,
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm3/kafy/arm", arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
marb_trial_f<-function(DIDE_CODE, ## Southern Province Sierre Leone 102761
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm3/marbiah/arm", arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
nevi_trial_f<-function(DIDE_CODE, ## Southern Province Sierre Leone 102761
  ...
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 ...
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm3/nevill/arm", arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
PHILHO_trial_f1<-function(DIDE_CODE,
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,sitnum,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm3/philipshoward/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe", ## The model executable
                 Root="P:/validating_modelling/input_files",
...
pbo_trial_f2<-function(DIDE_CODE,
  ...
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net",net_type,draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm3/protopopoff/arm", arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
STAEDKE_trial_f<-function(DIDE_CODE, ## Uganda 103270
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net",net_type,draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm3/staedke/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe", ## The model executable
                 Root="P:/validating_modelling/input_files",
...
west_trial_f1<-function(arm,run,
  ...
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net",net_type,draw,run, sep = "_"), ## filepath
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm3/west/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe", ## The model executable
                 Root="P:/validating_modelling/input_files",
                 Demog = "demog_GADM18_103222.txt",    ## Match up for Kagera
