...
ctx <- context::context_save(root, 
                             ...
                             sources = "functions_validations_netparms_2.r", ##Any functions I need
...
arm1 = read.csv("Input_files/data/Model_params/input_params_1_net_parameters2_all_hutdata.csv",header=TRUE)
...
## Data parameter input files
arm1 = read.csv("Input_files/data/Model_params/input_params_2_net_parameters2_all_hutdata.csv",header=TRUE)
...
## Data parameter input files
arm1 = read.csv("Input_files/data/Model_params/input_params_3_net_parameters2_all_hutdata.csv",header=TRUE)
...
## Data parameter input files
arm1 = read.csv("Input_files/data/Model_params/input_params_4_net_parameters2_all_hutdata.csv",header=TRUE)
...
## Data parameter input files
arm1 = read.csv("Input_files/data/Model_params/input_params_5_net_parameters2_all_hutdata.csv",header=TRUE)
...
## Data parameter input files
arm1 = read.csv("Input_files/data/Model_params/input_params_6_net_parameters2_all_hutdata.csv",header=TRUE)
...
## Data parameter input files
arm1 = read.csv("Input_files/data/Model_params/input_params_7_net_parameters2_all_hutdata.csv",header=TRUE)
...
library("dplyr")
## Data parameter input files
arm1 = read.csv("Input_files/data/Model_params/input_params_9_net_parameters2_all_hutdata.csv",header=TRUE)
## Site data,  
...
library("dplyr")
## Data parameter input files
arm1 = read.csv("Input_files/data/Model_params/input_params_10_net_parameters2_all_hutdata.csv",header=TRUE)
...
library("dplyr")
## Data parameter input files
arm1 = read.csv("Input_files/data/Model_params/input_params_11_net_parameters2_all_hutdata.csv",header=TRUE)
# arm1$total_M = rnorm(mean=81,sd=4,n=2000)
## Site data,  
...
library("dplyr")
## Data parameter input files
arm1 = read.csv("Q:/RProjects/Model_validation_ITN_IRS/Input_files/data/Model_params/input_params_12_update_net_parameters2_all_hutdataB.csv",header=TRUE)
...
library("dplyr")
## Data parameter input files
arm1 = read.csv("Q:/RProjects/Model_validation_ITN_IRS/Input_files/data/Model_params/input_params_13_net_parameters2_all_hutdata_B.csv",header=TRUE)
...
library("dplyr")
## Data parameter input files
arm1 = read.csv("Input_files/data/Model_params/input_params_14_net_parameters2_all_hutdata.csv",header=TRUE)
