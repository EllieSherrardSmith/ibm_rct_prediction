...
functions_model_runs_bradley<-function(DIDE_CODE,
  ...
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm4/bradley/arm", arm),
                 Options=Options,
...
chac_trial_f<-function(DIDE_CODE, ## Zambezia list 1:2000
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm4/chaccour/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
corb_trial_f1<-function(DIDE_CODE,
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm4/corbel/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
curt_trial_f1<-function(DIDE_CODE,
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm4/curtis/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
## CHECK THE CORRECT INPUT FILES ARE ADDED
# sim_file	sim_parms_6.txt                 ##Check year of trial, check age group of prevalence cohort etc unless on command line
# mosq_file	mosq_species_parms.txt        ##Using matched to study G 
# corr_file	corr_file_0.txt               ##check correlated
# itn_file	itn_parms_2010.txt          ##check on command line and input folder
# irs_file	irs_parms_ellie_pyrethroid.txt  ##use study default and check no IRS on if not implemented
# mda_file	mda_parms.txt                 ##prob wont use - interventions.txt drug 0 
# vacc_file	vacc_parms.txt                ##wont use - interventions.txt epi_[] 0
# output_file	output_vars_6.txt           ##specify for the trial (prev 0 to 14 year olds)
# model_file	model_parms.txt             ##will not change this
...
DALESS_trial_f1<-function(DIDE_CODE,
  ...
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,sitnum,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm4/dalessandro/arm",arm),
                 Options=Options,
...
HENRY_trial_f1<-function(DIDE_CODE,
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm4/henry/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe", ## The model executable
                 Root="P:/validating_modelling/input_files",
...
functions_model_runs_kafy<-function(DIDE_CODE,
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm4/kafy/arm", arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
## CHECK THE CORRECT INPUT FILES ARE ADDED
# sim_file	sim_parms_10.txt               ##Check year of trial, check age group of prevalence cohort etc unless on command line
# mosq_file	mosq_species_parms.txt        ##Check Q0 and phi unless in site file or command lines
# corr_file	corr_file_0.txt               ##check correlated
...
# mda_file	mda_parms.txt                 ##prob wont use - interventions.txt drug 0 
# vacc_file	vacc_parms.txt                ##wont use - interventions.txt epi_[] 0
# output_file	output_vars_10.txt           ##specify for the trial (Incidence 0 to 6 year olds; prevalence under 7s and under 6)
# model_file	model_parms.txt             ##will not change this
...
marb_trial_f<-function(DIDE_CODE, ## Southern Province Sierre Leone 102761
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm4/marbiah/arm", arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
nevi_trial_f<-function(DIDE_CODE, ## Southern Province Sierre Leone 102761
  ...
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net_1",draw,run, sep = "_"),
                 ...
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm4/nevill/arm", arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
PHILHO_trial_f1<-function(DIDE_CODE,
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,sitnum,"net_1",draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm4/philipshoward/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe", ## The model executable
                 Root="P:/validating_modelling/input_files",
...
pbo_trial_f2<-function(DIDE_CODE,
  ...
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net",net_type,draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm4/protopopoff/arm", arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe",
                 Root="P:/validating_modelling/input_files",
...
STAEDKE_trial_f<-function(DIDE_CODE, ## Uganda 103270
  ...
  ## Run the simulation
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net",net_type,draw,run, sep = "_"),
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm4/staedke/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe", ## The model executable
                 Root="P:/validating_modelling/input_files",
...
west_trial_f1<-function(arm,run,
  ...
  Model_launcher(OutputName = paste("VALIDATION_trial_arm",arm,"net",net_type,draw,run, sep = "_"), ## filepath
                 OutputRoot = paste0("P:/validating_modelling/output_files/FINAL_netparm4/west/arm",arm),
                 Options=Options,
                 Exe = "P:/validating_modelling/bin/irs_restructure.exe", ## The model executable
                 Root="P:/validating_modelling/input_files",
                 Demog = "demog_GADM18_103222.txt",    ## Match up for Kagera
